...
def load_data():
    ...
    return (X_train_img, X_val_img, X_test_img,
            ...
            y_test_enc, le, train_meta, val_meta, test_meta, NUM_CLASSES)

def train_models(X_train_img, y_train_cat, X_val_img, y_val_cat, train_meta, val_meta, NUM_CLASSES, BATCH_SIZE, NUM_EPOCHS, early_stop):
    # Augmentacija slika
    ...
    return cnn_model, history_cnn, multi_model, history_multi

# Evaluacija svega
def evaluate_models(cnn_model, multi_model, X_test_img, test_meta, y_test_enc, y_test_cat, le):
    # Evalvacija FAZE 1
